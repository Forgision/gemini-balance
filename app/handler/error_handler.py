...
async def handle_route_errors(
    ...
    Args:
        ...
        operation_name: The name of the operation, for logging and error details.
        success_message: A custom message to log on success (optional).
        failure_message: A custom message to log on failure (optional).
    """
