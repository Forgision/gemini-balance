...
from app.service.error_log.error_log_service import ErrorLogListResponse
...
async def delete_all_error_logs_api(
    ...
    try:
        await error_log_service.process_delete_all_error_logs(session=session)
