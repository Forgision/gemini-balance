...
def test_list_models_success(mock_verify_auth_token, route_client, mocker):
...
def test_list_models_unauthorized(route_client):
    ...
    try:
        ...
        route_client.app.dependency_overrides[gemini_routes.security_service.verify_key_or_goog_api_key] = override_security
...
def test_list_models_no_valid_key(mock_verify_auth_token, route_client, route_mock_key_manager):
...
def test_list_models_derived_models(mock_verify_auth_token, route_client):
    """Test that derived models are correctly added."""
    pass

# Tests for content generation
def test_generate_content_success(mock_verify_auth_token, route_client, route_mock_chat_service, mocker):
    ...
    response = route_client.post("/gemini/v1beta/models/gemini-pro:generateContent", json=request_payload)
...
def test_generate_content_unsupported_model(mock_verify_auth_token, route_client, mocker):
    ...
    response = route_client.post("/gemini/v1beta/models/unsupported-model:generateContent", json=request_payload)
...
def test_stream_generate_content_success(mock_verify_auth_token, route_client):
    """Test successful streaming content generation."""
    pass

# Tests for token counting
def test_count_tokens_success(mock_verify_auth_token, route_client, route_mock_chat_service, mocker):
    ...
    response = route_client.post("/gemini/v1beta/models/gemini-pro:countTokens", json=request_payload)
...
# Tests for embedding
def test_embed_content_success(mock_verify_auth_token, route_client, route_mock_embedding_service, mocker):
    ...
    response = route_client.post("/gemini/v1beta/models/gemini-pro:embedContent", json=request_payload)
...
def test_batch_embed_contents_success(mock_verify_auth_token, route_client):
...
def test_reset_all_key_fail_counts_success(mock_verify_auth_token, route_client):
    ...
    try:
        ...
        route_client.app.dependency_overrides[gemini_routes.get_key_manager] = override_get_key_manager
...
def test_reset_selected_key_fail_counts_success(mock_verify_auth_token, route_client):
    """Test successful reset of selected key fail counts."""
    pass

def test_reset_key_fail_count_success(mock_verify_auth_token, route_client):
    """Test successful reset of a single key fail count."""
    pass

def test_verify_key_success(mock_verify_auth_token, route_client):
    """Test successful key verification."""
    pass

def test_verify_selected_keys_success(mock_verify_auth_token, route_client):
